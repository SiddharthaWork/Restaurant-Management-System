...
const ExpenseTrackingChart = () => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-5 max-w-3xl mx-auto shadow-md overflow-hidden sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col items-center justify-between mt-5 border-t border-gray-300 pt-3 sm:flex-row sm:space-x-4">
...
export default ExpenseTrackingChart;
